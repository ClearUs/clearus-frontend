    ...
    return (
        <div className="w-full text-center max-w-4xl mx-auto space-y-4 mb-10">
            <motion.h1
                ...
                className="text-4xl md:text-5xl lg:text-6xl font-serif italic mb-4 text-white font-normal tracking-tight leading-tight"
            >
            ...
            <motion.p
                ...
                className="text-white/40 max-w-2xl mx-auto tracking-wide mb-10 text-sm md:text-base leading-relaxed"
            >
